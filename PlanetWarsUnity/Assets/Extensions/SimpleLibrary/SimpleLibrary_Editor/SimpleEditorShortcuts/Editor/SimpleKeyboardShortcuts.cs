...
namespace SimpleLibrary
{
	public class SimpleKeyboardShortcuts
	{
		...
		private static void ToggleGameObjectActiveState_Alt_A()
		{
			ToggleGameObjectActiveState();
		}

		[MenuItem("GameObject/Create Empty Child &n")]
		private static void CreateNewEmptyGameObjectChild_Alt_N()
		{
			CreateGameObjectChild();
		}

		[MenuItem("Edit/Rename &r")]
		private static void Rename_Alt_R()
		{
			Rename();
		}

		[MenuItem("GameObject/Wrap in Empty &w")]
		private static void WrapInObject_Alt_W()
		{
			WrapInGameObject();
		}
